...
| `Skin_research_tools.py` | LangChain tools: `analyze_skin_image`, `analyze_skin_video`, `medical_web_search`, `research_paper_search`, `scrape_medical_url`. Includes Tavily retry/backoff + TTL cache, Gemini vision routing (inline vs File API), HF fallback. |
